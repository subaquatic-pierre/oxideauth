    ...
    svc_reg
        ...
        .create(
            ...
            CredentialCreateParams {
                ...
                workspace_id: Some(system_ws.id),
                membership_id: None,
    ...
    let memberships: Vec<(WorkspaceCache, MembershipCreateParams)> = vec![
        (
            ...
            MembershipCreateParams {
                ...
                workspace_id: Some(system_ws_id),
        ...
        (
            ...
            MembershipCreateParams {
                account_id: Some(owner.id.into()),
                email: owner.email.clone(),
                workspace_id: Some(default_ws_id),
                scope: MembershipScope::Workspace,
                status: Some(MembershipStatus::Active),
                profile: None,
                project_id: None,
...
pub async fn seed_test_data<D: DbExecutor, C: CacheExecutor>(
    ...
    svc_reg
        ...
        .create(
            ...
            CredentialCreateParams {
                ...
                workspace_id: Some(public_ws.id),
                membership_id: None,
                kind: CredentialKind::Password,
                provider: CredentialProvider::Local,
                status: CredentialStatus::Active,
    ...
    svc_reg
        ...
        .create(
            ...
            CredentialCreateParams {
                ...
                workspace_id: Some(private_ws.id),
                membership_id: None,
                kind: CredentialKind::Password,
                provider: CredentialProvider::Local,
                status: CredentialStatus::Active,
    ...
    let memberships: Vec<MembershipCreateParams> = vec![
        ...
        MembershipCreateParams {
            ...
            email: test_account.email.clone(),
            workspace_id: Some(test_ws.id),
            scope: MembershipScope::Workspace,
            status: Some(MembershipStatus::Active),
            profile: None,
        ...
        MembershipCreateParams {
            ...
            email: public_admin.email.clone(),
            workspace_id: Some(public_ws.id),
            scope: MembershipScope::Workspace,
            status: Some(MembershipStatus::Active),
            profile: None,
        ...
        MembershipCreateParams {
            ...
            email: private_admin.email.clone(),
            workspace_id: Some(private_ws.id),
            scope: MembershipScope::Workspace,
            status: Some(MembershipStatus::Active),
            profile: None,
